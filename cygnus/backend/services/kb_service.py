...
live on WikiPage rows. Search is handled by cygnus/backend/services/wiki_service.py.
...
from cygnus.backend.ai.wiki_compiler import compile_source_into_wiki
from cygnus.backend.database.models import KnowledgeType, Source, SourceImage
from cygnus.backend.services.image_service import ImageInfo, extract_images
