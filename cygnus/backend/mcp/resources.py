...
def register_resources(mcp: FastMCP):
    ...
    async def about_cygnus() -> str:
        """About this Cygnus instance — capabilities and instructions."""
        return (
            "# Cygnus Knowledge Base\n\n"
            "You are connected to a Cygnus support knowledge operating system. Knowledge is organized "
    ...
    @mcp.resource("cygnus://knowledge-index")
    async def wiki_index_resource() -> str:
        ...
        from cygnus.backend.mcp.tools import _get_identity
