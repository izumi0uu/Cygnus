...
class WikiPage(Base):
    ...
    # See cygnus/backend/ai/embedding_catalog.py and migration 015.
...
class WikiPageDraft(Base):
    ...
    # See cygnus/backend/services/ai_review/runner.py for the JSON shape.
...
# search & ingestion read/write. See cygnus/backend/ai/embedding_catalog.py.
