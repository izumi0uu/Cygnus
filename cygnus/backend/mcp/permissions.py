...
the tool in `tools/list`. The `ScopedToolsMiddleware` (cygnus/backend/mcp/middleware.py)
...
from cygnus.backend.services.mcp_auth_service import ResolvedIdentity
