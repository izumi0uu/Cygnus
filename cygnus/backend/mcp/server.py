...
from cygnus.backend.mcp.middleware import ScopedToolsMiddleware
from cygnus.backend.mcp.resources import register_resources
from cygnus.backend.mcp.tools import register_tools
...
def create_mcp_server() -> FastMCP:
    ...
    mcp = FastMCP(
        "Cygnus",
        instructions=(
            "You are connected to Cygnus — the company's support knowledge control plane. "
            "\n\n"
            "## MANDATORY: Always search Cygnus before answering\n"
            ...
            "you MUST query Cygnus first. Do NOT answer from general knowledge alone "
