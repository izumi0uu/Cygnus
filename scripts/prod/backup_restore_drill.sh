...
if [ -n "${CYGNUS_CERTIFICATION_TARGET_ORIGIN:-}" ]; then
  for variable in CYGNUS_CERTIFICATION_BACKUP_DATABASE_URL CYGNUS_CERTIFICATION_BACKUP_MINIO_ENDPOINT CYGNUS_CERTIFICATION_BACKUP_MINIO_ACCESS_KEY CYGNUS_CERTIFICATION_BACKUP_MINIO_SECRET_KEY CYGNUS_CERTIFICATION_BACKUP_MINIO_BUCKET CYGNUS_CERTIFICATION_BACKUP_MINIO_SECURE; do
    require "$variable"
  done
  CYGNUS_BACKUP_DATABASE_URL="$CYGNUS_CERTIFICATION_BACKUP_DATABASE_URL"
  CYGNUS_BACKUP_MINIO_ENDPOINT="$CYGNUS_CERTIFICATION_BACKUP_MINIO_ENDPOINT"
  CYGNUS_BACKUP_MINIO_ACCESS_KEY="$CYGNUS_CERTIFICATION_BACKUP_MINIO_ACCESS_KEY"
  CYGNUS_BACKUP_MINIO_SECRET_KEY="$CYGNUS_CERTIFICATION_BACKUP_MINIO_SECRET_KEY"
  CYGNUS_BACKUP_MINIO_BUCKET="$CYGNUS_CERTIFICATION_BACKUP_MINIO_BUCKET"
  CYGNUS_BACKUP_MINIO_SECURE="$CYGNUS_CERTIFICATION_BACKUP_MINIO_SECURE"
