...
def _sections_from_outline(
    ...
    from cygnus.backend.services.source_outline import flatten_outline_with_depth
...
async def _write_page_complex(
    ...
    Returns (content_md, summary, citations_meta).
    """
    from cygnus.backend.ai.agent_protocol import assistant_message_from_turn, tool_results_message
    ...
    for step in range(WRITER_AGENT_MAX_STEPS):
        from cygnus.backend.ai.agent_protocol import AssistantTurn
        try:
