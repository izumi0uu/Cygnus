...
from cygnus.backend.database.models import WikiLink, WikiPage, WikiPageDraft, WikiPageRevision
...
async def search_pages_semantic(
    ...
    from cygnus.backend.database.models import get_embedding_model_for_dim
