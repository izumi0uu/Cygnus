...
from cygnus.runtime.services.auth_service import require_permission
...
def _normalize_reasoning_effort(
    ...
    *,
    ...
    from cygnus.runtime.ai.registry import CUSTOM_LLM_REASONING_EFFORTS
...
async def get_llm_catalog(
    ...
    from cygnus.runtime.ai.llm_catalog import list_specs
...
async def switch_llm_model(
    ...
    from cygnus.runtime.ai.llm_catalog import UnknownLLMModel, get_spec
...
async def test_custom_llm(
    ...
    from cygnus.runtime.ai.registry import CUSTOM_LLM_PROVIDER_IDS
    from cygnus.runtime.services.config_service import LLM_CUSTOM_API_KEY, ConfigService
...
async def save_custom_llm(
    ...
    from cygnus.runtime.ai.registry import (
...
async def get_vision_catalog(
    ...
    from cygnus.runtime.ai.registry import ProviderRegistry
    from cygnus.runtime.ai.vision_catalog import list_specs
    from cygnus.runtime.services.config_service import ConfigService
