...
def create_mcp_server() -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "5. `validate_publish_policy` — re-check approval, source readiness, audience bindings, "
            "and object version before a durable command.\n"
            "6. `publish_knowledge_object` — administrator-only durable publication; a successful "
