...
from cygnus.backend.services.auth_service import get_current_user, require_permission
...
async def _suggested_reviewers(
    ...
    """
    from cygnus.backend.database.models import WikiPageRevision
...
async def list_all_drafts(
    ...
    if mine:
        ...
        from cygnus.backend.database.models import WikiBranch
