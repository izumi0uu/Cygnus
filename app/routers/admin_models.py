...
def _normalize_reasoning_effort(
    ...
    *,
    ...
    from app.ai.registry import CUSTOM_LLM_REASONING_EFFORTS
...
async def test_custom_llm(
    ...
    from app.ai.registry import CUSTOM_LLM_PROVIDER_IDS
    from app.services.config_service import LLM_CUSTOM_API_KEY, ConfigService
...
async def disable_custom_llm(
    ...
    from app.ai.registry import ProviderRegistry
    from app.services.config_service import LLM_CUSTOM_ENABLED_KEY, ConfigService
