...
class CustomLLMSettings:
    ...
    def build_spec(self):
        from cygnus.runtime.ai.llm_catalog import LLMModelSpec
...
class ProviderRegistry:
    ...
    async def get_active_embedding_spec_id(self) -> Optional[str]:
        ...
        from cygnus.runtime.ai.embedding_catalog import EMBEDDING_CATALOG
    ...
    async def get_active_vision_spec_id(self) -> Optional[str]:
        ...
        from cygnus.runtime.ai.vision_catalog import VISION_CATALOG, derive_spec_id
        from cygnus.runtime.services.config_service import (
    ...
    async def _load_llm_config(self) -> ProviderConfig:
        ...
        """
        from cygnus.runtime.ai.llm_catalog import get_spec
    ...
    async def _load_vision_config(self) -> ProviderConfig:
        ...
        from cygnus.runtime.ai.vision_catalog import get_spec
        from cygnus.runtime.services.config_service import ConfigService
...
def supported_providers() -> dict:
    ...
    """
    from cygnus.runtime.ai.embedding_catalog import EMBEDDING_CATALOG
    from cygnus.runtime.ai.llm_catalog import LLM_CATALOG
    from cygnus.runtime.ai.vision_catalog import VISION_CATALOG
