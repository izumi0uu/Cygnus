...
CERTIFICATION_CAPACITY_THRESHOLDS_FILE="${CYGNUS_CAPACITY_THRESHOLDS_FILE:-}"
...
load_prod_env
if [ -n "$CERTIFICATION_CAPACITY_THRESHOLDS_FILE" ]; then
  export CYGNUS_CAPACITY_THRESHOLDS_FILE="$CERTIFICATION_CAPACITY_THRESHOLDS_FILE"
fi
if [ -n "$CERTIFICATION_CAPACITY_TARGETS_FILE" ]; then
  export CYGNUS_CAPACITY_TARGETS_FILE="$CERTIFICATION_CAPACITY_TARGETS_FILE"
fi
if [ -n "$CERTIFICATION_ALERT_THRESHOLDS_FILE" ]; then
  export CYGNUS_ALERT_THRESHOLDS_FILE="$CERTIFICATION_ALERT_THRESHOLDS_FILE"
fi
