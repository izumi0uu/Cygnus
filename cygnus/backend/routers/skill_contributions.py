...
from cygnus.backend.routers.skills import is_text_file
...
from cygnus.backend.services.skill_service import SkillService
...
async def upload_skill_contribution_file(
    ...
    if not root_folder:
        ...
        if not root_folder:
            from cygnus.backend.utils.text import slugify
