"""Governance control-plane recovery proof surfaces for Cygnus.

Ownership:
- recovery proof / frontline reality-check surfaces live here
- this module is part of recovery governance, not the publish package owner
"""
